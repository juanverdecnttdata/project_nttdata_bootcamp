...
public class Constant implements Serializable {
  ...
  public static final String urlAccount = "http://localhost:8085";
  public static final String getAccountById = "/account/getAccountById/";
  public static final String urlUser = "http://localhost:9095";
